...
def _reset_columns(*, wipe_input_address: bool) -> Iterable[tuple[str, object]]:
    ...
    # Decision/flags
    yield ("error_code", "")
    yield ("reference_homepage", "")
    yield ("reference_phone", "")
    yield ("reference_address", "")
    yield ("accuracy_homepage", "")
    yield ("accuracy_phone", "")
    yield ("accuracy_address", "")
    ...
    yield ("homepage_fingerprint", "")
    yield ("homepage_content_length", 0)
    yield ("homepage_checked_at", "")
    yield ("homepage_check_url", "")
    yield ("homepage_check_source", "")
    yield ("homepage_check_logic_hash", "")
    ...
    yield ("ai_reason", "")
    yield ("concept_normalization_json", "")
    yield ("concept_version", "")
    yield ("embedding_model_name", "")
    yield ("ai_prompt_version", "")
    ...
    # Enrichment
    yield ("industry", "")
    yield ("industry_major_code", "")
    yield ("industry_major", "")
    yield ("industry_middle_code", "")
    yield ("industry_middle", "")
    yield ("industry_minor_code", "")
    yield ("industry_minor", "")
    yield ("industry_minor_item_code", "")
    yield ("industry_minor_item", "")
    yield ("industry_class_source", "")
    yield ("industry_class_confidence", 0.0)
    yield ("industry_suggested_major_code", "")
    yield ("industry_suggested_major", "")
    yield ("industry_suggested_middle_code", "")
    yield ("industry_suggested_middle", "")
    yield ("industry_suggested_minor_code", "")
    yield ("industry_suggested_minor", "")
    yield ("industry_suggested_minor_item_code", "")
    yield ("industry_suggested_minor_item", "")
    yield ("industry_suggested_source", "")
    yield ("industry_suggested_confidence", 0.0)
    yield ("industry_tag_matches", "")
    yield ("business_tags", "")
    yield ("license", "")
    yield ("employees", "")
    yield ("contact_url", "")
    yield ("contact_url_source", "")
    yield ("contact_url_score", 0.0)
    yield ("contact_url_reason", "")
    yield ("contact_url_checked_at", "")
    yield ("contact_url_ai_verdict", "")
    yield ("contact_url_ai_confidence", 0.0)
    yield ("contact_url_ai_reason", "")
    yield ("contact_url_status", "")
